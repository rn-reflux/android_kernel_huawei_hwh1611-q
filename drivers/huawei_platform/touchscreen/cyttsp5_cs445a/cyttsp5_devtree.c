		...
		struct device_node *core_node)
{
	...
	pdata->ttda_cap_test_enable = get_of_u32_val(core_node, "cy,ttda_cap_test_enable", 0);
	...
	pdata->fw_name_depend_lcd = get_of_u32_val(core_node, "cy,fw_name_depend_lcd", 0);

...
/* h1611 ofilm ttconfiger */
#include "./ttconfig/h1611_ttconfig_ofilm.h"
static struct touch_settings cyttsp5_sett_param_regs_h1611_ofilm = {
	.data = (uint8_t *)&cyttsp5_param_regs_h1611_ofilm[0],
	.size = ARRAY_SIZE(cyttsp5_param_regs_h1611_ofilm),
	.tag = 0,
};

static struct touch_settings cyttsp5_sett_param_size_h1611_ofilm = {
	.data = (uint8_t *)&cyttsp5_param_size_h1611_ofilm[0],
	.size = ARRAY_SIZE(cyttsp5_param_size_h1611_ofilm),
	.tag = 0,
};

static struct cyttsp5_touch_config cyttsp5_ttconfig_h1611_ofilm = {
	.param_regs = &cyttsp5_sett_param_regs_h1611_ofilm,
	.param_size = &cyttsp5_sett_param_size_h1611_ofilm,
	.fw_ver = ttconfig_fw_ver_h1611_ofilm,
	.fw_vsize = ARRAY_SIZE(ttconfig_fw_ver_h1611_ofilm),
	.panel_id = FW_OFILM,
	.product_name = PHONE_NAME_H1611,
};

/* h1611 toptouch ttconfiger */
#include "./ttconfig/h1611_ttconfig_toptouch.h"
static struct touch_settings cyttsp5_sett_param_regs_h1611_toptouch = {
	.data = (uint8_t *)&cyttsp5_param_regs_h1611_toptouch[0],
	.size = ARRAY_SIZE(cyttsp5_param_regs_h1611_toptouch),
	.tag = 0,
};

static struct touch_settings cyttsp5_sett_param_size_h1611_toptouch = {
	.data = (uint8_t *)&cyttsp5_param_size_h1611_toptouch[0],
	.size = ARRAY_SIZE(cyttsp5_param_size_h1611_toptouch),
	.tag = 0,
};

static struct cyttsp5_touch_config cyttsp5_ttconfig_h1611_toptouch = {
	.param_regs = &cyttsp5_sett_param_regs_h1611_toptouch,
	.param_size = &cyttsp5_sett_param_size_h1611_toptouch,
	.fw_ver = ttconfig_fw_ver_h1611_toptouch,
	.fw_vsize = ARRAY_SIZE(ttconfig_fw_ver_h1611_toptouch),
	.panel_id = FW_TOPTOUCH,
	.product_name = PHONE_NAME_H1611,
};
...
static struct cyttsp5_touch_config *cyttsp5_ttconfigs[] = {
	...
	&cyttsp5_ttconfig_h1611_ofilm,
	&cyttsp5_ttconfig_h1611_toptouch,
#endif
	NULL, /* Last item should always be NULL */
};

...
static struct cyttsp5_panel_info hw_panel_info[] = {
	{"Kiwi", "CS445A", 0, "ofilm"},
	{"Kiwi", "CS445A", 4, "gis"},
	{"h1611","CYTT21403", 0,"ofilm"},
	{"h1611","CYTT21403", 18, "toptouch"},
};
					...
					char *config_file)
{
	...
	strncat(parameter_file, TP_CONFIG_FILE_PATH,
...
int cyttsp5_cm_cp_test(struct seq_file *m, void *v)
{
	...
	error =
		cyttsp5_get_tp_config_file(dev, parameter_filename,
					config_filename);
	if (error < 0) {
	...
	/*
	 * ttda solution not need paramter file anymore
	 */

...
extern ssize_t release_wakelock_show(struct device *dev,
		struct device_attribute *attr, char *buf);

extern ssize_t release_wakelock_store(struct device *pdev,
		struct device_attribute *attr, const char *buf, size_t size);
DEVICE_ATTR(release_wakelock, (00664), release_wakelock_show, release_wakelock_store);

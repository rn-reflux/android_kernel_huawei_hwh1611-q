...
/*
 * tp use lcd panel name to choice firmware,
 * if get lcd panel name fail, this type of error will be report
 */
#define DSM_TP_GET_LCD_PANEL_NAME_ERROR_NO	(20011)
...
#define DSM_LEDS_SEND_MODEM_FAILED                             (21701)
